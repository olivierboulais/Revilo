      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, background: "rgba(248,247,244,0.9)", backdropFilter: "blur(12px)", borderBottom: "1px solid rgba(28,28,26,.08)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px", height: 56, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
            <svg width="72" height="22" viewBox="0 0 169 52" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 52V0H21.8182C31.8182 0 39.0909 6.5 39.0909 16C39.0909 22.5 35.4545 27.5 30 30L42 52H29L18.1818 31H12V52H0ZM12 21H21.8182C25.4545 21 27.2727 18.5 27.2727 16C27.2727 13.5 25.4545 11 21.8182 11H12V21Z" fill="#1C1C1A"/><path d="M58 52V0H100V11H70V20H96V31H70V41H100V52H58Z" fill="#1C1C1A"/><path d="M113 52L97 0H110L121 38L132 0H145L129 52H113Z" fill="#1C1C1A"/><path d="M147 52V0H159V52H147Z" fill="#1C1C1A"/><path d="M163 52V0H175V41H200V52H163Z" fill="#1C1C1A"/><path d="M202 52V0H233C243 0 250.273 6.5 250.273 16V36C250.273 45.5 243 52 233 52H202ZM214 41H233C236.636 41 238.455 38.5 238.455 36V16C238.455 13.5 236.636 11 233 11H214V41Z" fill="#1C1C1A"/></svg>
          </Link>
