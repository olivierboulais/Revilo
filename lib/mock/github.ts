...
export async function fetchGithubComponents(): Promise<RawComponent[]> {
  return [
    ...
    { source: "github", name: "Input", path: "src/components/forms/Input", variants: ["default", "error"], props: ["placeholder", "value", "onChange"] },
    { source: "github", name: "Checkbox", path: "src/components/forms/Checkbox", variants: ["unchecked", "checked", "indeterminate"], props: ["disabled", "onChange"] },
    { source: "github", name: "Select", path: "src/components/forms/Select", variants: ["default", "open", "disabled"], props: ["options", "onSelect"] },
    ...
    { source: "github", name: "Tabs", path: "src/components/navigation/Tabs", variants: ["default", "pills"], props: [] },
    { source: "github", name: "Accordion", path: "src/components/Accordion", variants: ["default"], props: [] },
    { source: "github", name: "Breadcrumb", path: "src/components/navigation/Breadcrumb", variants: ["default"], props: [] },
    { source: "github", name: "Pagination", path: "src/components/navigation/Pagination", variants: ["default", "compact"], props: [] },
    ...
    { source: "github", name: "DatePicker", path: "src/components/forms/DatePicker", variants: ["default", "range"], props: [] },
    { source: "github", name: "Slider", path: "src/components/forms/Slider", variants: ["default", "range"], props: [] },
    { source: "github", name: "Switch", path: "src/components/forms/Switch", variants: ["default"], props: [] },
    { source: "github", name: "RadioGroup", path: "src/components/forms/RadioGroup", variants: ["default"], props: [] },
